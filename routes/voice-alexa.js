                ...
                checkAnswer(sessionId, 'people:' + guess, (obj, addSuggestions) => {
                    ...
                    if (obj.question) {
                        ...
                        const cardDisplayText = `
                            ...
                            <br/>
                            <br/>
                            Q${currentQuestion + 1}. ${obj.question.questionText}
                        `;
                        let questionTitle = `Question ${currentQuestion + 1}`;
                        responseTemplate = createQuestionTemplate.call(this, questionTitle, cardDisplayText, questionItems, obj.image);
                        ...
                        let richTextResponse =
                            `<font size = '3'>${responseText}</font><br/><br/><font size = '2'>${obj.score}</font>`;
...
*/
function createQuestionTemplate(headerText, bodyText, answerOptions, articleImage = null) {
